...
class TestBlueprintMeta:
    ...
    def test_not_found(client, mocker, patch_auth_wrapper):
        mocker.patch('opera.api.service.sqldb_service.Database.get_blueprint_meta', return_value=None)
...
class TestBlueprintName:
    ...
    def test_post_success(mocker, client, patch_auth_wrapper):
        mocker.patch('opera.api.service.sqldb_service.Database.update_blueprint_name', return_value=True)
    ...
    def test_post_fail(mocker, client, patch_auth_wrapper):
        mocker.patch('opera.api.service.sqldb_service.Database.update_blueprint_name', return_value=False)
    ...
    def test_get_success(mocker, client, patch_auth_wrapper):
        name = 'foo'
        mocker.patch('opera.api.service.sqldb_service.Database.get_blueprint_name', return_value=name)
    ...
    def test_get_fail(mocker, client, patch_auth_wrapper):
        mocker.patch('opera.api.service.sqldb_service.Database.get_blueprint_name', return_value=None)
...
class TestGetDeployments:
    ...
    def test_success(mocker, client, generic_deployment, patch_auth_wrapper):
        ...
        mocker.patch('opera.api.service.sqldb_service.Database.get_deployments_for_blueprint',
